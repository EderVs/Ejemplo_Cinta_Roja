package mx.devf.ejemplocintaroja;
    ...
    public static class PlaceholderFragment extends Fragment
        ...
        public void onClick(View v) {
            ...
            switch (idClickedView){
                case R.id.btn_one:
                    Toast.makeText(getActivity(), "Botón uno", Toast.LENGTH_SHORT).show();
                    break;
                case R.id.btn_two:
                    Intent secondaryIntent = new Intent(getActivity(), SecondaryActivity.class);
